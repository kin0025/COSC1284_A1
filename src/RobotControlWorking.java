...
/**
 * Created by akinr on 18/03/2016.
 */
 ...
 * alex@akinrosssmith.id.au
 */
class RobotControlWorking {
    private Robot r;

    public RobotControlWorking(Robot r) {
        this.r = r;
    }
...
*/
        ...
        return (optimisationOrder(optimisationBars, optimisation, barNumbers, numberOfThrees));
    }
